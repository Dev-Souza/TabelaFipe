...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        //Função para pegar a marca em específico
        var marcas = conversor.obterLista(json, Dados.class);
        marcas.stream()
                .sorted(Comparator.comparing(Dados::codigo))
                .forEach(System.out::println);

        System.out.println("Qual código da marca para a consulta: ");
        ...
        System.out.println("Digite um trecho do nome do carro pra ser buscado:");
